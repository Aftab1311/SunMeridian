  ...
  return (
    <section className="bg-gradient-to-b from-[#F9F6F1] to-[#f0e9dd] py-12 sm:py-16 lg:py-20 xl:py-24 relative overflow-hidden min-h-[600px] lg:min-h-screen">
      ...
      >
        ...
        >
          Sun Meridian <span className="text-orange-600 relative inline-block">
            School
            <motion.svg
        ...
        >
          ...
          >
            ...
            <span className="text-gray-700 text-xs sm:text-sm font-medium">Join school of excellence</span>
          </motion.div>
        </motion.div>
